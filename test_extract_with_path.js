...
async function testExtractWithPath() {
  try {
    ...
    const pdfPath = 'C:\\Users\\danie\\Documents\\mobius-games-tutorial-generator\\uploads\\1751722917481_Jaipur.pdf';
    
    console.log('Extracting components from PDF path:', pdfPath);
    const response = await axios.post('http://127.0.0.1:5001/api/extract-components', {
      pdfPath: pdfPath
    }, {
      headers: {
