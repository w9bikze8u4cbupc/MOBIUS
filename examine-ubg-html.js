...
async function examineHtml() {
  ...
  if (resolved.html) {
    ...
    const compHeaders = $('h1,h2,h3,h4,h5,h6').filter((_, el) => {
      ...
      return (
        txt.includes('components') ||
        txt.includes('contents') ||
        txt.includes('setup') ||
        txt.includes('spielmaterial') ||
        txt.includes('contenu') ||
        txt.includes('componentes') ||
        txt.includes('componenti') ||
        txt.includes('matériel') ||
        txt.includes('composants') ||
        txt.includes('contenidos') ||
        txt.includes('materiale')
      );
    });
