...
// Test cases
const testCases = [
  { newMinFps: 90, existingMinFps: 100, expected: true, description: 'New FPS is lower than existing' },
  { newMinFps: 100, existingMinFps: 90, expected: false, description: 'New FPS is higher than existing' },
  { newMinFps: 100, existingMinFps: 100, expected: false, description: 'New FPS equals existing' },
  { newMinFps: 0, existingMinFps: 5, expected: true, description: 'New FPS is zero, existing is positive' },
  { newMinFps: 5, existingMinFps: 0, expected: false, description: 'New FPS is positive, existing is zero' }
];
...
testCases.forEach((testCase, index) => {
  ...
  console.log(`  Input: newMinFps=${testCase.newMinFps}, existingMinFps=${testCase.existingMinFps}`);
