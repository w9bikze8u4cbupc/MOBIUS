...
import { loadGameProfile, normalizeComponentName, isSupplyOnly, validateComponentCounts } from './src/utils/game-profiles.js';
  ...
  try {
    ...
    if (validation.issues.length > 0) {
      ...
      validation.issues.forEach(issue => {
        console.log(`     - ${issue.type}: ${issue.component} (expected: ${issue.expected}, actual: ${issue.actual})`);
      });
    }
