...
console.log('\nAcceptance Criteria:');
console.log(
  `High precision (≥ 0.90): ${precisionH >= 0.9 ? '✅ PASS' : '❌ FAIL'} (${precisionH.toFixed(3)})`,
);
console.log(
  `High+Medium recall (≥ 0.85): ${recallHM >= 0.85 ? '✅ PASS' : '❌ FAIL'} (${recallHM.toFixed(3)})`,
);
