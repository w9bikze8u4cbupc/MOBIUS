...
function testEnhancedNegative() {
  ...
  if (hasGameBoard) {
    console.log(`  ⚠️  Line: "4 Player boards" -> extracted "Game board" (may be expected depending on normalization rules)`);
    console.log(`     This might be correct behavior if "Player boards" normalizes to "Game board"`);
  } else {
