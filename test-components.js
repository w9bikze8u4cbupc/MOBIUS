...
async function testEnhancedComponentExtraction() {
  ...
  try {
    ...
    try {
      const textResponse = await axios.post('http://localhost:5001/api/process-text', {
        text: sampleText,
  ...
  const expectedComponents = [
    'Ally cards', 'Location tiles', 'Lord cards', 'game board', 
    'player boards', 'plastic pearls', 'Kraken figure', 
    'Influence tokens', 'wooden cubes', 'Crown token'
  ];
