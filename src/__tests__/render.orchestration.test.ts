...
describe('Render Orchestration', () => {
  ...
  describe('render function', () => {
    ...
    beforeEach(() => {
      (spawn as jest.Mock).mockReturnValue(mockSpawnInstance);
    });

    test('should validate inputs and throw error when images are missing', async () => {
      const job = { ...mockJob, images: [] };
    ...
    test('should handle FFmpeg execution timeout', async () => {
      ...
      (spawn as jest.Mock).mockReturnValue(mockSpawnInstanceWithTimeout);
    ...
    test('should handle FFmpeg execution error', async () => {
      ...
      (spawn as jest.Mock).mockReturnValue(mockSpawnInstanceWithError);
