...
describe('Size and Proximity Scoring', () => {
  ...
  test('proximityScore increases when closer to components', () => {
    ...
    const near = scoreImageCandidate({
      w: 320,
      h: 240,
      sectionDistance: 1,
      providerWeight: 1,
  ...
  test('sizeScore is capped to prevent outliers', () => {
    ...
    const large = scoreImageCandidate({
      w: 4000,
      h: 2500,
      sectionDistance: 3,
      providerWeight: 1,
  ...
  test('proximityScore uses exponential decay', () => {
    const veryClose = scoreImageCandidate({
      w: 320,
      h: 240,
      sectionDistance: 0,
      providerWeight: 1,
    ...
    const close = scoreImageCandidate({
      w: 320,
      h: 240,
      sectionDistance: 1,
      providerWeight: 1,
