...
test('a verified semantic composition may reuse exact component identity only after final composition review', () => {
  ...
  const sequence = { contract: 'mobius-source-grounded-semantic-sequence-v2', materializerContract: 'mobius-visual-plan-materializer-v8', semanticTeaching: true, sceneId: 'scene', assetId: 'card-asset', sourceTeaching: teaching,
    ...
    review: { scenes: [{ scene_id: 'scene', candidates: [{ status: 'MEASURED', evidencePacket: { visualRole: 'COMPOSITION', responseContract: 'normalized-composition-sequence-v2', materializerContract: 'mobius-visual-plan-materializer-v8', sequenceContract: 'mobius-source-grounded-semantic-sequence-v2',
...
test('a final instructional diagram selects every source asset through one exact scene proof', () => {
  ...
  const sequence = { contract: 'mobius-source-grounded-instructional-diagram-v2', materializerContract: 'mobius-visual-plan-materializer-v8', instructionalDiagram: true, sceneId: 'scene', assetId: 'board-asset', sourceTeaching: teaching,
    sourceAssets: [{ assetId: 'board-asset', sourceImageSha256: hash }, { assetId: 'token-asset', sourceImageSha256: hash }], frames,
    review: { scenes: [{ scene_id: 'scene', candidates: [{ status: 'MEASURED', evidencePacket: { visualRole: 'COMPOSITION', responseContract: 'normalized-composition-sequence-v2', materializerContract: 'mobius-visual-plan-materializer-v8', sequenceContract: 'mobius-source-grounded-instructional-diagram-v2',
