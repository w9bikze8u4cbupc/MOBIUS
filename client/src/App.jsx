        ...
        >
          ...
          <div style={{ display: 'flex', gap: '10px', flexWrap: 'wrap' }}>
            ...
            <button
              ...
              disabled={
                (!bggUrl.trim() && !extraImageUrls.trim()) || isExtractingImages
              }
              style={{
                padding: '0.5em 1.5em',
                fontSize: '1em',
        ...
        <div style={{ marginBottom: 20 }}>
          ...
          >
            ...
            <input
              ...
              onChange={e => handleMetadataChange('play_time', e.target.value)}
                    ...
                    <div style={{ padding: 16, overflow: 'hidden' }}>
                      {webLoading ? (
                        ...
                        <div style={{ color: '#64748b' }}>
                          ...
                          the query is prefilled as “{gameName} + component” for
