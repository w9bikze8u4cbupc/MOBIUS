    ...
    try {
      ...
      if (data.success) {
        setFields({
          ...
          minPlayTime:
            data.play_time.split('-')[0]?.replace('min', '').trim() || '',
          maxPlayTime:
            data.play_time.split('-')[1]?.replace('min', '').trim() || '',
    ...
    >
      ...
      <form>
        ...
        <div>
          ...
          <input
            type="text"
            value={`${fields.minPlayers} - ${fields.maxPlayers}`}
            readOnly
            style={{ width: '100%' }}
          />
        </div>
        <div>
          ...
          <input
            type="text"
            value={`${fields.minPlayTime} - ${fields.maxPlayTime}`}
            readOnly
            style={{ width: '100%' }}
          />
        </div>
        ...
        <div>
          ...
          <input
            type="text"
            value={arrayToString(fields.publishers)}
            readOnly
            style={{ width: '100%' }}
          />
        </div>
        <div>
          ...
          <input
            type="text"
            value={arrayToString(fields.designers)}
            readOnly
            style={{ width: '100%' }}
          />
        </div>
        <div>
          ...
          <input
            type="text"
            value={arrayToString(fields.artists)}
            readOnly
            style={{ width: '100%' }}
          />
        </div>
        <div>
          ...
          <input
            type="text"
            value={arrayToString(fields.categories)}
            readOnly
            style={{ width: '100%' }}
          />
        </div>
        <div>
          ...
          <input
            type="text"
            value={arrayToString(fields.mechanics)}
            readOnly
            style={{ width: '100%' }}
          />
        </div>
