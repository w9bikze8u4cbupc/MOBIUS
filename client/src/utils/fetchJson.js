/**
 * Browser-compatible fetchJson utility
 * Enhanced fetch wrapper for React client with axios-like behavior
 */
...
/**
 * Enhanced fetch wrapper with axios-like behavior for browsers
 ...
 * @param {string} options.responseType - Response type ('json', 'text', 'blob', 'arrayBuffer')
