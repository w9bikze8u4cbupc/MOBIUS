...
### Prerequisites
- You are on branch `chore/workspace-canonicalize-and-quarantine`
- You have reviewed the triage classification
- You understand files will be moved (not deleted)
