...
/**
 * MOBIUS DHash System - Standalone Health Server
 * Provides health and metrics endpoints for testing
 */
...
// Update metrics endpoint (internal use)
app.post('/internal/metrics/update', (req, res) => {
...
app.listen(PORT, () => {
  console.log(`🚀 MOBIUS DHash Health Server running on port ${PORT}`);
